...
public class v1_6_R1 implements RBInterface {

	RealisticBackpacks plugin;

	public v1_6_R1(final RealisticBackpacks rb) {
		this.plugin = rb;
	}
	...
	public ItemStack addGlow(final ItemStack item) {
		final net.minecraft.server.v1_6_R1.ItemStack handle = CraftItemStack.asNMSCopy(item);
