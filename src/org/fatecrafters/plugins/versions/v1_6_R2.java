...
public class v1_6_R2 implements RBInterface {

	RealisticBackpacks plugin;

	public v1_6_R2(final RealisticBackpacks rb) {
		this.plugin = rb;
	}
	...
	public String inventoryToString(final Inventory inventory) {
		...
		for (int i = 0; i < inventory.getSize(); i++) {
			...
			net.minecraft.server.v1_6_R2.ItemStack craft = null;
	...
	public ItemStack addGlow(final ItemStack item) {
		final net.minecraft.server.v1_6_R2.ItemStack handle = CraftItemStack.asNMSCopy(item);
